    ...
    return(
        <div className="container-fix" id='HD'>
            <div className="row" id='ro'>
                ...
                <a href="https://github.com/med1seghir5/med1seghir5" ><button className='btn fw-medium'  id='social3'><BsGithub/> github</button></a>
                </div>
                <div className="col-6" id='button'>
                      <div id='button2'>
                        ...
                        <Link><p className="btn fw-medium" id='Aboutme'>About me</p></Link>                  
                      </div>
                </div>
            </div>
        </div>
